...
const ButtonCircle=({label,link,icon,page})=>{
    return (
        <div className='mb-8'>
            <div className={`flex flex-row transform origin-right justify-center items-center duration-300 rounded-full ${page === true ? 'bg-[#8A2BE2]' : 'bg-[#252525]'} h-12 w-12 group hover:w-28`}>
