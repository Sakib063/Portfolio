    ...
    return (
        <>
            <header className='md:hidden fixed top-0 left-0 w-full bg-[#252525] flex justify-between items-center pb-2 z-50'>
                <h1 className='ml-4 text-3xl font-bold text-[#8A2BE2] mt-2'>{word[0]} <span className='text-white'>{word[1]}</span></h1>
                <span className='cursor-pointer mr-6 text-[#8A2BE2] text-3xl mt-4' onClick={toggle_menu}>
            ...
            {menu && (
                <div className={`md:hidden text-3xl fixed top-0 left-0 h-full bg-[#252525] shadow-lg z-50 p-4 transform transition-transform duration-1000 ${menu ? 'translate-x-0' : '-translate-x-full'} w-full md:w-1/3 lg:w-1/4`}>
                    <span className='flex justify-end cursor-pointer mx-2 text-[#8A2BE2] text-3xl' onClick={toggle_menu}>
                        <ion-icon name="close-outline"></ion-icon>
                    </span>
                    <nav>
                        <ul>
                            <li className={`my-4 ${path === '/' ? 'text-[#8A2BE2]' : 'text-white'}`}>
                            ...
                            <li className={`my-4 ${path === '/about-me' ? 'text-[#8A2BE2]' : 'text-white'}`}>
                            ...
                            <hr className='border-t-2 border-[#333333]'/>
                            <li className={`my-4 ${path === '/projects' ? 'text-[#8A2BE2]' : 'text-white'}`}>
                            ...
                            <hr className='border-t-2 border-[#333333]'/>
                            <li className={`my-4 ${path === '/my-stories' ? 'text-[#8A2BE2]' : 'text-white'}`}>
                            ...
                            <hr className='border-t-2 border-[#333333]'/>
                            <li className={`my-4 ${path === '/contact' ? 'text-[#8A2BE2]' : 'text-white'}`}>
