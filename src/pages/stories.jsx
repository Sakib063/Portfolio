        ...
        <>
                ...
                <div className='flex flex-col md:flex-row my-10'>
                    ...
                    <div>
                        <p>
                            ...
                            in that class had to team up and make a group project. My university hosted a project show
                            at the end of each semester which is an exhibition for each and every project from every
                            lab course. All the projects were graded by judges and top 3 project from each course were
                            awarded. Electronics lab was among the lab courses which was part of the project show. At
                            that time I knew nothing about how to make a project. Day one of that course I made a five
                            member group with four of my friends. That group was given the name Error Sage. The first
                            task was coming up with an idea for the project. We had thought about two ideas but the day
                            we presented them, they were rejected. But within ten minutes or so one of my friend came up
                            with the smart bike parking project idea. Funny thing was he was staring at a bike when he
                            ...
                            project.
                            I hold dear to my heart the time we spent together as a team working on this project. This
                            is where
                            our friendship grew. To this day I am very good friends with these 4 individual and we have
                            gone to
                            more journeys together.
                            <br/>
                            <br/>
                            Finally the day of the project show came. We presented the project and the idea behind it to
                            the
                            judges. At the end of the day we sat at the award giving ceremony. I personally was not
                            confident
                            that we would win any prize. It was an utter surprise when the announcer said that our team
                            was the
                        ...
                        <br/>
                        <p>
                            As the name suggests this is a system where bikes can be parked in the designated stalls and
                            they
                ...
                <div className='flex flex-col md:flex-row my-10'>
                    <div className='md:w-1/2'>
                        <p>
                            ...
                            ideas. One of my ideas was to build a home automation system for the physically challenged
                            ...
                            prototype.
                            We presented that prototype to our department heads and with this prototype we were able to
                            impress our department heads and they gave us with the much needed funding. Now comes the
                            part
                            of getting the passport and visa, most difficult part of this journey. Even thinking about
                            these
                            events stresses me out. It was literally impossible to get our passports and visas in such
                            short
                            notice but by the divine intervention of the Almighty Allah we managed to get the proper
                            documentations. And on 24 March, 2023 that dream was becoming reality. By the grace of the
                            Almighty we set foot in India.
                            <br/>
                            <br/>
                            After 30 hours of traveling over bus, taxi, plane and on foot carrying pounds of baggage we
                ...
                <div className='flex flex-col md:flex-row my-10'>
                    ...
                    <div>
                        <p>
                            ...
                            based on
                            all that research we did on paper. We struggled a lot at first on how to actually implement
                            blockchain.
                            And we were working with permission blockchain which was much harder than public or private
                            blockchain
                            technology. But thanks to my amazing teammates we discovered Multichain which was the
                            perfect tool for
                            our project. At the same time we were also learning NextJs. We were simultaneously learning
                            all the new
                            technologies and working on developing our project.
                            <br/>
                            <br/>
                            At the end all our hard work paid off. Our project got a lot of praises. It even featured on
                            the
                            university screen for a day. I am very proud of the work that we did. I am once again very
                            grateful
                            to the people who were involved in this project, especially my supervisor sir and course
                            teacher.
                            My supervisor sir is an amazing person and I respect him a lot.
                        </p>
                        <br/>
                        <br/>
                        <p>
            ...
            <div className='text-white my-24 md:mt-16 w-4/5 mx-auto'>
                ...
                <div className='md:w-1/2 md: mx-auto'>
                    <p>
                        Back in 2018 Model United Nations(MUN) was the most trending extra curricular activity for
                        college and university students. One of my friends had attended a MUN at his college and
                        told
                        me all about it. MUN is a simulation of United Nations conferences where each students
                        works as the representative of a country and must solve a problem with other delegates from
                        around the
                        world. It emphasises on research, public speaking, debating, writing, critical thinking,
                        teamwork
                        and leadership. Typically a MUN would be hosted for three to five days.
                        I was quite hyped when I heard about MUN and wanted to experience this event. I was
                        particularly
                        excited because it was a formal event and everyone had to suit up for the event.
                        <br/>
                        <br/>
                        After a couple of months later I registered in the NDC MUN which was a three day event. I
                        was given
                        the UNHCR committee and given the country the Republic of Croatia. That was the time where
                        Bangladesh
                        was having a rohingya refugee crisis and the topic we were given was on how to solve this
                        crisis.
                        It took a good amount of time for me to research all about Croatia's foreign and refugee
                        policies.
                        <br/>
                        <br/>
                        At that time I struggled with public speaking and speaking in english as I am not a native
                        english speaker. The first day when the dias chairman asked which countries would like to present
                        their opening arguments I was quite nervous to raise my hand but I did it anyway. I stood up nervously
                        when my name was called and gave my opening statements. And over the span of the event I spoke a few more
                        times. Even though I was still nervous about speaking while standing amid all these other people I
                    ...
                    <p>
                        ...
                        ceremony where the prizes were given I was quite surprised when I was given an honorable mention.
                        It was an amazing experience.
                    </p>
                </div>
            </div>
                <img src={mun} className='hidden md:block w-auto h-auto md:w-1/2 mx-4 my-8 md:my-0'/>
        </>
    )
}
