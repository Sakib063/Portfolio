...
const AboutMe=()=>{
    ...
    return(
        <>
            ...
            <div className='flex justify-center my-14 md:justify-end md:w-11/12'><ButtonBig label={'More of Me'} icon={'arrow-forward-sharp'} link={'/my-stories'}/></div>
            ...
            <div className='flex justify-center my-14 md:justify-end md:w-11/12'><ButtonBig label={'Explore More'} icon={'arrow-forward-sharp'} link={'/projects'}/></div>
            <hr className='w-1/2 mx-auto my-10 md:w-1/4 border-t-2 border-[#252525]'/>
